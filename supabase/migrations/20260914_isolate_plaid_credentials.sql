...
-- Creates isolated, private credentials table for Plaid access tokens.
...
-- Note: Intentionally NO SELECT/INSERT/UPDATE/DELETE policies for public or authenticated roles.
-- This ensures client applications querying via Supabase client will receive 0 rows / permission denied.
-- Only the Supabase Service Role (used by Edge Functions) bypasses RLS.
